...
(`kind = "scatter"`) or
[lineplot](https://reaborn.org/dev/reference/lineplot.md)
(`kind = "line"`) onto a grid of facets defined by `row`/`col`. Returns
a [reaborn_plot](https://reaborn.org/dev/reference/reaborn_plot.md) (a
faceted ggplot) with the legend outside, like a seaborn FacetGrid.
