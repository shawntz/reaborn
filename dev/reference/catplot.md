...
[stripplot](https://reaborn.org/dev/reference/stripplot.md)
(`kind = "strip"`),
[boxplot](https://reaborn.org/dev/reference/boxplot.md),
[barplot](https://reaborn.org/dev/reference/barplot.md),
[pointplot](https://reaborn.org/dev/reference/pointplot.md), or
[countplot](https://reaborn.org/dev/reference/countplot.md) and adds
row/col faceting. Returns a faceted
