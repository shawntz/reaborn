...
| Goal | Function(s) |
|----|----|
| Relationships between numeric variables | [`scatterplot()`](https://reaborn.org/dev/reference/scatterplot.md), [`lineplot()`](https://reaborn.org/dev/reference/lineplot.md), [`relplot()`](https://reaborn.org/dev/reference/relplot.md) |
| Distributions | [`histplot()`](https://reaborn.org/dev/reference/histplot.md), [`kdeplot()`](https://reaborn.org/dev/reference/kdeplot.md), [`ecdfplot()`](https://reaborn.org/dev/reference/ecdfplot.md), [`displot()`](https://reaborn.org/dev/reference/displot.md) |
| Categorical comparisons | [`boxplot()`](https://reaborn.org/dev/reference/boxplot.md), [`violinplot()`](https://reaborn.org/dev/reference/violinplot.md), [`barplot()`](https://reaborn.org/dev/reference/barplot.md), [`stripplot()`](https://reaborn.org/dev/reference/stripplot.md), [`catplot()`](https://reaborn.org/dev/reference/catplot.md) |
| Model fits | [`regplot()`](https://reaborn.org/dev/reference/regplot.md), [`lmplot()`](https://reaborn.org/dev/reference/lmplot.md) |
| Matrices | [`heatmap()`](https://reaborn.org/dev/reference/heatmap.md), [`clustermap()`](https://reaborn.org/dev/reference/clustermap.md) |
| Multi-plot grids | [`pairplot()`](https://reaborn.org/dev/reference/pairplot.md), [`jointplot()`](https://reaborn.org/dev/reference/jointplot.md) |

See the [Gallery](https://reaborn.org/dev/articles/gallery.md) for live
...
| [`sns.set_theme()`](https://reaborn.org/dev/reference/sns-aliases.md) | *automatic on load* |
