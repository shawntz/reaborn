...
SEABORN_PALETTES <- list(
  ...
  colorblind6 = c("#0173B2", "#029E73", "#D55E00", "#CC78BC", "#ECE133", "#56B4E9")
)
...
SEABORN_COLOR_CODES <- list(
  deep = c(b = "#4C72B0", g = "#55A868", r = "#C44E52", m = "#8172B3",
           y = "#CCB974", c = "#64B5CD", k = "#1A1A1A"),
  muted = c(b = "#4878D0", g = "#6ACC64", r = "#D65F5F", m = "#956CB4",
            y = "#D5BB67", c = "#82C6E2", k = "#1A1A1A")
)
