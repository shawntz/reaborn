...
- **Skip the boilerplate.** One call to `histplot(data, x="x", hue="g")` sets up
  seaborn's binning, palette, and theme. From there, add `+ facet_wrap(~year) +
  scale_x_log10()` and keep going.
